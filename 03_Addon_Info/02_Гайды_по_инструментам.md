...
+ [Standalone Pre-1130](https://link.meridiano-web.com/sse:ck-16438) - полный комплект CK64, который не требует от тебя использовать Bethesda Launcher. Для версий игры до 1.6.1130.
+ [Standalone Post-1130](https://link.meridiano-web.com/sse:ck-161130) - то же, что и выше, но для версий игры от 1.6.1130 и не содержит [Creation Kit Fixes](https://www.nexusmods.com/skyrimspecialedition/mods/71371).

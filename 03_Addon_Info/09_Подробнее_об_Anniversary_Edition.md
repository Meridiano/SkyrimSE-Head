...
4. Если вы не хотите обновляться сразу же, то сделайте следующее:
    ...
    + (Опционально) Завершите работу Steam, найдите файл "appmanifest_489830.acf" в папке "steamapps" в библиотеке Steam и переименуйте его в "appmanifest_489830.acf.backup". После запуска Steam больше не станет её обновлять, но время игры и даже достижения будут засчитываться как обычно.

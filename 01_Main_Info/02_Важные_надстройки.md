...
**2) [SSE Engine Fixes](https://www.nexusmods.com/skyrimspecialedition/mods/17230)** - SKSE64-плагин, который содержит исправления различных аспектов движка игры. Это и падение FPS в некоторых локациях, и удвоение перков NPC, и кое-что другое (читай [файл с настройками](https://github.com/aers/EngineFixesSkyrim64/blob/master/Skyrim/Data/SKSE/Plugins/EngineFixes.toml)). Включает в себя некоторые другие фиксы, такие как:
...
> Внимание! Windows 7 больше не поддерживается, и мод не работает на Windows 7 и старых версиях Windows 10 (до Fall Creators Update).
...
**4) [SkyUI](https://www.nexusmods.com/skyrimspecialedition/mods/12604)** - мод, требуемый для многих других модов, поскольку добавляет возможность их настройки через специальные меню (MCM). К тому же ванильный интерфейс может понравиться только консольщику, а SkyUI приводит его в божеский вид. Есди у тебя последняя версия игры (или её файлы ESM и BSA в папке Data), а также старая версия SkyUI 5.2, не забудь [Quest Journal Fix](https://www.nexusmods.com/skyrimspecialedition/mods/108618).

------

**5) [SSE Russian Fix](https://www.nexusmods.com/skyrimspecialedition/mods/887)** - фиксы для русскоязычных игроков (русские текстуры, компас и шрифты для консоли), про которые Беседка просто забыла. Есть альтернатива только для исправления квадратов в консоли на последней версии игры - [Skyrim SE Console Font Fix](https://link.meridiano-web.com/sse:16x-console).

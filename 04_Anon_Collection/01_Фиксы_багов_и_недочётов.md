...
**Vendor Max Gold Fix:** замена Simple Barter Fix, немного костыльно исправляет баг, при котором ГГ не получает деньги от продажи предметов, если у торговца около 32 тысяч септимов и больше.

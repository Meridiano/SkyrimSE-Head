...
| [SSE Russian Fix](https://www.nexusmods.com/skyrimspecialedition/mods/887) | Русифицированные текстуры и исправление шрифта в консоли и на компасе. | | Исправление консоли для 1.6.X лучше взять [здесь](https://link.meridiano-web.com/sse:16x-console). |
...
| [SSE CreationKit Fixes](https://www.nexusmods.com/skyrimspecialedition/mods/20061) и [Unicode Fix](https://gamer-mods.ru/load/skyrim_se/patchi/creation_kit_64_sse_unicode/153-1-0-10628) | Набор исправлений Creation Kit для любителей создавать свои моды и править чужие. | | Полный комплект со всеми зависимостями [здесь](https://link.meridiano-web.com/sse:ck-1573). |
...
| [Unofficial High Definition Audio Project](https://www.nexusmods.com/skyrimspecialedition/mods/18115) | Исправляют звук в SSE, т.к. для переиздания на PC Беседка использовала далеко не лучшее сжатие, и качество звука заметно пострадало. | | Если тебе нужны лишь голоса, есть [перенос только их от анона](https://link.meridiano-web.com/sse:rus-voice). |

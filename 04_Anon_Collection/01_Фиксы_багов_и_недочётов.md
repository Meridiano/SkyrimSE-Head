...
**SSE Character Specular Lighting Fix**: исправление отражения света от тела персонажа. Конфликтует с SSS в ENBSeries, так что используй что-то одно (начиная с версии 0.370 этот баг исправлен и там).
